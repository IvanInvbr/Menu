Proceso Menu_ciclos
	Definir opcion, c, dece, uni, conta, j, base, altura, vocal, espe, espaci, conso Como Entero;
	Definir n,h1, p2, k3,type, val1,suma, val2, cuenta,f,tomo, contador, l, v,h,m,s,d,e,mayor, menor, num, promedio,x,i,t,z Como Real;
	Definir cadvocal, consonantes, espacio, especiales, nombre, num1, num2, name,clav,calif,correo como cadena;
	Definir p,data,q,pipe,r,g,b, pe,ze, names Como Caracter;
	Repetir
		Limpiar Pantalla;
